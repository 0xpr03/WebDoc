...
public class WNeueAnamneseTabs extends WModelPane {
	 ...
	 */
	public WNeueAnamneseTabs(boolean is_editable, long animal_id, long anamnesis_id,
		...
		String allgemeineAnamnese = "Algemeine Anamnese";
		...
		tabber.addTab(allgemeineAnamnese, null, tabbedPane, null);
		tPAenderungenFamilie = new JTextPane();
		
				JPanel pContent = new JPanel();
				tabbedPane.addTab(allgemeineAnamnese + " 1", null, pContent, null);
...
//		panel_4.setLayout(gl_panel_4);
			...
			gl_panel_6.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_6.createSequentialGroup()
					...
					.addGroup(gl_panel_6.createParallelGroup(Alignment.TRAILING)
						.addComponent(sPRoentgen, GroupLayout.DEFAULT_SIZE, 457, Short.MAX_VALUE)
						.addComponent(sPCTMRT, GroupLayout.DEFAULT_SIZE, 457, Short.MAX_VALUE))
					.addGap(1))
		);
		gl_panel_6.setVerticalGroup(
			gl_panel_6.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_6.createSequentialGroup()
					.addComponent(sPRoentgen, GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
					.addGap(1)
					.addComponent(sPCTMRT, GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
					.addGap(1))
		);
		panel_6.setLayout(gl_panel_6);
		
		panel_7 = new JPanel();
		tabbedPane.addTab(allgemeineAnamnese + " 2", null, panel_7, null);
		panel_7.setLayout(new BorderLayout(0, 0));
		
		splitPane_1 = new JSplitPane();
		panel_7.add(splitPane_1, BorderLayout.CENTER);
		...
		splitPane_1.setLeftComponent(panel_15);
				...
				JLabel lblEpilemtiformeAnflle = new JLabel("Epilemtiforme Anfälle:");
							...
							gl_panel_15.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_15.createSequentialGroup()
									...
									.addGroup(gl_panel_15.createParallelGroup(Alignment.LEADING)
										.addComponent(SPBauchspeicheldruese, GroupLayout.DEFAULT_SIZE, 339, Short.MAX_VALUE)
										.addComponent(sPEndokrinium, GroupLayout.DEFAULT_SIZE, 339, Short.MAX_VALUE)
										.addGroup(gl_panel_15.createSequentialGroup()
											.addComponent(lblEpilemtiformeAnflle)
											.addGap(68)
											.addComponent(cBEpiAnfaelle, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
									.addGap(1))
						);
						gl_panel_15.setVerticalGroup(
							gl_panel_15.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_15.createSequentialGroup()
									.addGap(1)
									.addComponent(SPBauchspeicheldruese, GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
									.addGap(1)
									.addComponent(sPEndokrinium, GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
									.addGap(1)
									.addGroup(gl_panel_15.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panel_15.createSequentialGroup()
											.addGap(3)
							...
							gl_panel_13.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_13.createSequentialGroup()
									...
									.addGroup(gl_panel_13.createParallelGroup(Alignment.LEADING)
										.addComponent(sPSchilddruese, GroupLayout.DEFAULT_SIZE, 628, Short.MAX_VALUE)
										.addComponent(sPZNS, GroupLayout.DEFAULT_SIZE, 628, Short.MAX_VALUE))
									.addGap(1))
						);
						gl_panel_13.setVerticalGroup(
							gl_panel_13.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_13.createSequentialGroup()
									.addGap(1)
									.addComponent(sPSchilddruese, GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
									.addGap(1)
									.addComponent(sPZNS, GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
									.addGap(1))
						);
						panel_13.setLayout(gl_panel_13);
						
						panel_16 = new JPanel();
						tabbedPane.addTab(allgemeineAnamnese + " 3", null, panel_16, null);
						panel_16.setLayout(new BorderLayout(0, 0));
						
						splitPane_3 = new JSplitPane();
						panel_16.add(splitPane_3, BorderLayout.CENTER);
						splitPane_3.setRightComponent(panel_6);
						splitPane_3.setLeftComponent(panel_5);
						GroupLayout gl_panel_5 = new GroupLayout(panel_5);
						gl_panel_5.setHorizontalGroup(
							gl_panel_5.createParallelGroup(Alignment.LEADING)
								.addComponent(sPMedikamente, GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE)
						);
						gl_panel_5.setVerticalGroup(
							gl_panel_5.createParallelGroup(Alignment.LEADING)
								.addComponent(sPMedikamente, GroupLayout.DEFAULT_SIZE, 380, Short.MAX_VALUE)
						);
