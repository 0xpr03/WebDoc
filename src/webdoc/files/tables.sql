...
CREATE TABLE IF NOT EXISTS `anamnesis` (
 ...
 `ZNS` text NOT NULL,
 `epileptiformAttacks` tinyint(4) NOT NULL,
 ...
 `possibleWalkDistance` double NOT NULL,
 `possibleWalkDuration` time NOT NULL,
 `weatherDependent` tinyint(4) NOT NULL,
 `cycleCorrelation` text NOT NULL,
 `outlet` double NOT NULL,
 `availableTimeCons` time NOT NULL,
