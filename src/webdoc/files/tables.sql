...
CREATE TABLE IF NOT EXISTS `anamnesis` (
 ...
 `scars` text NOT NULL,
 `infectiousDisease` text NOT NULL,
 `regularVaccinations` text NOT NULL,
 `breathing` text NOT NULL,
 `digestiveTract` text NOT NULL,
 `endocrineSystem` text NOT NULL,
 `hyperthyroidism` text NOT NULL,
 `pancreas` text NOT NULL,
 `ZNS` text NOT NULL,
 `epileptiformAttacks` text NOT NULL,
 ...
 `painSensitivity` text NOT NULL,
 `patientHasPain` text NOT NULL,
 `painkillerReaction` text NOT NULL,
 `motionCausingPain` text NOT NULL,
 `motorInterference` text NOT NULL,
 `bodyPartUsagePossible` text NOT NULL,
 `possibleWalkDistance` text NOT NULL,
 `possibleWalkDuration` text NOT NULL,
 `weatherDependent` text NOT NULL,
 `cycleCorrelation` text NOT NULL,
 `outlet` text NOT NULL,
 `availableTimeCons` text NOT NULL,
